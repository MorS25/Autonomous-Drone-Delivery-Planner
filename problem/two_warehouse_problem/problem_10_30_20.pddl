(define (problem amazon)
	...
	(:init
		...
		(at-drone drone9 warehouse2)
		(at-drone drone10 warehouse2)
		...
		(at-package package25 warehouse2)
		(at-package package26 warehouse2)
		(at-package package27 warehouse2)
		(at-package package28 warehouse2)
		(at-package package29 warehouse2)
		(at-package package30 warehouse2)
		...
		(= (move-time warehouse1 customer19) 20)
		(= (move-time warehouse1 customer20) 21)
		...
		(= (move-time customer19 warehouse1) 20)
		(= (move-time customer20 warehouse1) 21)
		...
		(= (move-time warehouse2 customer17) 5)
		(= (move-time warehouse2 customer18) 4)
		(= (move-time warehouse2 customer19) 3)
		(= (move-time warehouse2 customer20) 2)
		...
		(= (move-time customer17 warehouse2) 5)
		(= (move-time customer18 warehouse2) 4)
		(= (move-time customer19 warehouse2) 3)
		(= (move-time customer20 warehouse2) 2)
	...
	(:goal (and
		...
		(at-package package25 customer15)
		(at-package package26 customer16)
		(at-package package27 customer17)
		(at-package package28 customer18)
		(at-package package29 customer19)
		(at-package package30 customer20)
	))
)